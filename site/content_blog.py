...
BLOG_PAGES = [
    {
        ...
        "nav_active": "",
        "priority": "0.6",
        "title": "Car Care and Detailing Tips for Casa Grande & Pinal County | Supreme Clean Detailing",
        ...
        "hero_sub": "No fluff, just straight pricing answers, desert-specific advice, and the questions customers actually text us.",
        "crumbs": [("Blog", None)],
        "sections": [
            (
                "cards",
    ...
    },
    {
        ...
        "desc": "How mobile detailing is priced in Casa Grande AZ in 2026, including what drives the number up or down and how to get your exact quote before you book.",
...
<p>Being based in Casa Grande is our structural advantage, with no commute cost to pass on and no shop
...
spilled milk in July, or years of skipped cleanings add labor hours, all quoted upfront from your photos,
never sprung on you afterward.</li>
<li><strong>Extras.</strong> Odor treatment, pet hair removal, headlight restoration and engine bay are each quoted upfront with your detail. Add what you need, skip what you don't.</li>
</ul>
...
timeline, because appraisers see everything.</p>
            ...
            (
                "faq",
                {
                    ...
                    "items": [
                        ...
                        ("Do you charge more for Maricopa / Eloy / Coolidge?", "<p>No. Everything inside the <a href='/service-areas/'>service area</a> is standard rate, with no travel fees.</p>"),
...
<p>After a good haboob you'll find silt in the door seals, vents, window channels and even the cupholders of a
...
for exactly this). A seasonal <a href="/services/interior-detailing/">interior deep clean</a>, with
steam on hard surfaces and extraction in carpet, pulls the desert back out of the cabin.</p>
...
<li><strong>Monthly, June to September:</strong> <a href="/services/exterior-detailing/">wash &amp; shine</a>
...
mostly roll in from the southeast) and skip the cheap car cover, because a cover over dust <em>is</em>
the sandpaper.</li>
</ol>
...
""",
            ...
            (
                "faq",
                {
                    ...
                    "items": [
                        ("A haboob hit yesterday, is a tunnel wash okay today?", "<p>Please don't. The brushes are loaded with everyone else's grit. Rinse-only touchless is acceptable triage; a hand wash is the fix.</p>"),
                        ("Are water spots after monsoon rain permanent?", "<p>Fresh ones, no, just wash promptly. Baked in for weeks, they can etch. We offer dedicated spot treatment when that's happened, so send a photo for a straight quote.</p>"),
                        ("Does sealant actually help with dust?", "<p>Noticeably. Sealed paint is slick, so dust has less to grab and it rinses instead of bonding. That's why it's included in our wash &amp; shine.</p>"),
                    ],
                },
            ),
            CTA,
